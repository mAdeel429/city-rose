...
//               {localMacro && (
//                 <div
//                 className="macro-bubble-wrapper sticky-top"
//                 >
//                   <div
//                    className="macro-bubble selected"
//                    >
//                     {macroIcons[localMacro]}
//                     <span>{localMacro}</span>
//                   </div>
//                 </div>
//               )}
...
//                           <label
//                             key={tag}
//                             className={`checkbox-option pill-only ${
//                               activeTags[localMacro]?.[section]?.includes(tag) ? 'selected' : ''
//                             }`}
//                             onClick={() => handleTagToggle(section, tag)}
//                           >
//                             {tag}
